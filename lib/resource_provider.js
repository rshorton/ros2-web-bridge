...
class ResourceProvider {
  ...
  // rsh added use_transient_local
  createSubscription(messageType, topicName, use_transient_local, callback) {
    return SubscriptionManager.getInstance().createSubscription(messageType, topicName, use_transient_local, this._bridgeId, callback);
  }
